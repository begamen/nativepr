...
class __TwigTemplate_06ba5e3ca164b913644ca4f58d9eebaaaad59060bc5050d3a74947356071c659 extends \Twig\Template
{
...
";
    ...
    {
        return new Source("{{ attach_library('sepia/remove-class-from-body') }}
<section id=\"tt-intro\" class=\"image-intro\">
<div class=\"tt-intro-inner full-height-vh tt-wrap bg-image\" style=\"background-image: url({{file_url(content.field_s_image['#items'].entity.uri.value)}}); background-position: 50% 50%;\">
<div class=\"cover bg-transparent-2-dark\"></div>
</div>
{{content.field_content }}
</section>
", "themes/custom/sepia/templates/paragraphs/paragraph--static-image-intro.html.twig", "/vagrant/nativepr/themes/custom/sepia/templates/paragraphs/paragraph--static-image-intro.html.twig");
    }
}
